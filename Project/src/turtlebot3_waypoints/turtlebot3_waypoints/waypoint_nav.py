...
class WaypointNavigator(Node):
    def __init__(self):
        ...
        # Values read from /goal_pose, from clicking on RViz with 2D Goal Pose
        self.waypoints = [
    ...
    # Convert numeric waypoint data to type geometry_msgs/PoseStamped
    # as it can be seen via `ros2 interface show nav2_msgs/action/NavigateToPose`
    ...
    # Run action for each goal, with feedback in case there is an error
    def run(self):
